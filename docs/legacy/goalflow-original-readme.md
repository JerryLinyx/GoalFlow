...
This file preserves the original repository README before the SafeSim experiment
workflow and documentation were reorganized.
...
- [Preparation of GoalFlow Environment](../install.md)
- [Evaluation](../test.md)
- [Training](../train.md)
